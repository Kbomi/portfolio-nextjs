...
const sideProjects: SideProjectProps[] = [
  {
    ...
    thumb: '/sideproject/dictionary_thumb.png',
  ...
  },
  {
    ...
    skill: 'HTML, CSS, JavaScript',
    thumb: '/sideproject/baseball_thumb.png',
