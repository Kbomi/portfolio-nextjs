...
export default function Career() {
  return (
    <section className="container mx-auto px-auto py-16">
      ...
      <p className="mt-4 text-center">2018년부터 웹 퍼블리셔로 다양한 프로젝트를 수행하며 React, Vue 등 프레임워크 기반 개발과 SCSS, Emotion, Bootstrap, Blueprint.js 등 스타일 및 디자인 시스템 활용 경험을 쌓았습니다. <br />
