...
export default function Projects() {
  return (
    <section className="container max-w-screen-xl flex items-center justify-center gap-4 mx-auto py-16 px-6">
      ...
      <div className='w-[60%]'>
        <h2 className="text-3xl font-bold text-primary">외주 프로젝트</h2>
        <p className="mt-4 text-gray-600">외주 프로젝트를 수행하며 폭넓은 경험을 쌓았습니다.<br />
        ...
        <div className='mt-12'>
          <Link href="/projects">
            <button className="px-6 py-3 bg-primary text-white rounded-lg hover:bg-blue-700">상세 더보기</button>
          </Link>
        </div>
      </div>
    </section>
